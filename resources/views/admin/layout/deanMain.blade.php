            ...
            <div class="sb2-1">
                ...
                <div class="sb2-12">
                    <ul>
                        ...
                        <li>
                             @php
                                $tutor_dean = \App\Tutor::where('id', $tutor_id)->first();
                            @endphp
                            <h5>{{$tutor_dean->name}} - Dean </h5>
                        </li>
                        <li>
                            <div>
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        <li><a href="javascript:;" class="menu-active"><i class="fa fa-bar-chart" aria-hidden="true"></i> Dashboard</a>
                        </li>

						<li style="display:none;"><a href="admin-setting.html"><i class="fa fa-cogs" aria-hidden="true"></i> Site Setting</a>
                        </li>

                        <li style="display:none;"><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-book" aria-hidden="true"></i>Courses</a>
                        ...
                        <li style="display:none"><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Users</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
