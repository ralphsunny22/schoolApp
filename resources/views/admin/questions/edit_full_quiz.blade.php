                        ...
                        <div class="row">
                            ...
                            <div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                     ...
                                     {{-- SESSION SECTION but not well positioned--}}
                                    ...
                                    <div class="tab-inn">
                                        <form method="POST" enctype="multipart/form-data" action="{{route('adminQuizUpdate', $question->id)}}">
                                            @csrf

                                            <div class="row">
                                                <div class="input-field col s6">
                                                <input id="datetimepicker" type="text" name="que_date" value="{{$question->que_date}}" class="validate" required>
                                                    <label class="">Date and time</label>
                                                </div>

                                                <div class="input-field col s4">
                                                <input id="start_timepicker" type="text" name="que_start_time" value="{{$question->que_start_time}}" class="validate" required>
                                                    <label class="">Start time</label>
                                                </div>

                                                <div class="input-field col s6">
                                                    <input type="text" name="que_time" id="timepicker" value="{{$question->que_time}}" class="validate" required>
                                            ...
                                            <div class="row">
                                                    <div id="expected_score" style="width:50%; margin-left:25%; margin-right:25%;" class="input-field col s12">
                                                        <input type="text" name="expected_score" value="{{$question->expected_score}}" class="validate" required>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <textarea name="detail">{{$question->detail}}</textarea>
                                        ...
                                        {{-- <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input type="text" name="option_A" value="{{$question->option_A}}" class="validate">
                                                    <label class="">OPTION A</label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input type="text" name="option_B" value="{{$question->option_B}}" class="validate">
                                                    <label class="">OPTION B</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                    <div class="input-field col s6">
                                                        <input type="text" name="option_C" value="{{$question->option_C}}" class="validate">
                                                        <label class="">OPTION C</label>
                                                    </div>
                                                    <div class="input-field col s6">
                                                        <input type="text" name="option_D" value="{{$question->option_D}}" class="validate">
                                            ...
                                            <div class="row">
                                                    <div class="input-field col s12">
                                                        <input type="text" name="option_correct" value="{{$question->option_correct}}" class="validate">
